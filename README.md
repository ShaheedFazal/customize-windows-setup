...
- (Optional, disabled by default) smart auto-shutdown after 9 PM when idle for 30 minutes

### 🎨 Interface & User Experience

**Taskbar & Start Menu Optimisation:**
- Hides search box, People icons, and Widgets
- Shows small taskbar icons for space efficiency
- Hides system tray icons for a cleaner notification area
...
**Intelligent Shutdown System (optional, disabled by default):**
- Monitors idle time after 9 PM and shuts down after 30 minutes of inactivity
- Optionally sends a webhook notification 60 seconds before power off
- Checks every 15 minutes until 3 AM
...
2. Run `ZZZ-Set-Wallpaper.ps1` to copy the image to `C:\wallpaper` and apply it.
